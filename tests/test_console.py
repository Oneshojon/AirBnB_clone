...
class TestAmenityDotNotation(unittest.TestCase):
    ...
    def test_update_amenity(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            am.name = "Cecilia"
            HBNBCommand().onecmd(HBNBCommand().precmd(
                                 f'Amenity.update({am.id}, name, "Daniel")'))
            self.assertEqual(am.__dict__["name"], "Daniel")
...
class TestCity(unittest.TestCase):
    ...
    def test_update_city(self):
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            cty = City()
            cty.name = "Cecilia"
            HBNBCommand().onecmd(f'update City {cty.id} name "Daniel"')
            self.assertEqual(cty.__dict__["name"], "Daniel")
